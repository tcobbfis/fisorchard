...
using Fis.Users.Commands;
using OrchardCore.Users.Indexes;
using Fis.Users.Liquid;
using YesSql.Filters.Query;
using Fis.Users.Controllers;
using OrchardCore.Users;
using UserOptions = OrchardCore.Users.UserOptions;
using Fis.Users.ViewModels;
using OrchardCore.Users.Models;
using LiquidUserAccessor = Fis.Users.Liquid.LiquidUserAccessor;
using OrchardCore.Users.Services;
using RolesAdminListFilterProvider = Fis.Users.Services.RolesAdminListFilterProvider;
using RoleAuthorizationHandler = Fis.Users.Services.RoleAuthorizationHandler;
using UserRoleRemovedEventHandler = Fis.Users.Services.UserRoleRemovedEventHandler;
using DefaultUsersAdminListFilterProvider = Fis.Users.Services.DefaultUsersAdminListFilterProvider;
using DefaultUsersAdminListFilterParser = Fis.Users.Services.DefaultUsersAdminListFilterParser;
using DefaultUsersAdminListQueryService = Fis.Users.Services.DefaultUsersAdminListQueryService;
using RecipeEnvironmentSuperUserProvider = Fis.Users.Services.RecipeEnvironmentSuperUserProvider;
using UsersThemeSelector = Fis.Users.Services.UsersThemeSelector;
using OrchardCore.Users.Handlers;
using ScriptExternalLoginEventHandler = Fis.Users.Handlers.ScriptExternalLoginEventHandler;
using SetupEventHandler = Fis.Users.Services.SetupEventHandler;
using MembershipService = Fis.Users.Services.MembershipService;
using DefaultUserIdGenerator = Fis.Users.Services.DefaultUserIdGenerator;
using EmailClaimsProvider = Fis.Users.Services.EmailClaimsProvider;
using RegistrationSettings = Fis.Users.Models.RegistrationSettings;
using ResetPasswordSettings = Fis.Users.Models.ResetPasswordSettings;
using Fis.Users.Drivers;
...
namespace Fis.Users
{
    public class Startup : StartupBase
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            services.Configure<UserOptions>(userOptions =>
            {
                ...
                configuration.GetSection("Fis_Users").Bind(userOptions);
            });
            ...
            //services.AddScoped<IDisplayDriver<ISite>, Fis.Users.Drivers.LoginSettingsDisplayDriver>();

            services.AddScoped<IDisplayDriver<FisUser>, Fis.Users.Drivers.FisUserDisplayDriver>();
            services.AddScoped<IDisplayDriver<FisUser>, Fis.Users.Drivers.UserInformationDisplayDriver>();
            services.AddScoped<IDisplayDriver<FisUser>, Fis.Users.Drivers.UserButtonsDisplayDriver>();
            ...
            //services.AddScoped<IDisplayDriver<Fis.Users.ViewModels.UserIndexOptions>, UserOptionsDisplayDriver>();
            ...
            //services.AddScoped<IDisplayDriver<Navbar>, Fis.Users.Drivers.UserMenuNavbarDisplayDriver>();
            //services.AddScoped<IDisplayDriver<FisUserMenu>, Fis.Users.Drivers.UserMenuDisplayDriver>();
    ...
    public class RolesStartup : StartupBase
    {
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDisplayDriver<FisUser>, Fis.Users.Drivers.UserRoleDisplayDriver>();
    ...
    public class ChangeEmailStartup : StartupBase
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            //services.AddScoped<IDisplayDriver<ISite>, Fis.Users.Drivers.ChangeEmailSettingsDisplayDriver>();
            services.AddScoped<IDisplayDriver<UserMenu>, Fis.Users.Drivers.ChangeEmailUserMenuDisplayDriver>();
        }
    }
    ...
    public class RegistrationStartup : StartupBase
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDisplayDriver<ISite>, Fis.Users.Drivers.RegistrationSettingsDisplayDriver>();
        }
    }
    ...
    public class ResetPasswordStartup : StartupBase
    {
        ...
        public override void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped<IDisplayDriver<ISite>, Fis.Users.Drivers.ResetPasswordSettingsDisplayDriver>();
        }
    }
    ...
    public class CustomUserSettingsStartup : StartupBase
    {
        public override void ConfigureServices(IServiceCollection services)
        {
            services.AddScoped<IDisplayDriver<FisUser>, Fis.Users.Drivers.CustomUserSettingsDisplayDriver>();
