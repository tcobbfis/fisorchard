...
{
    public class CustomUserSettingsDisplayDriver : DisplayDriver<FisUser>
    {
        ...
        public override Task<IDisplayResult> EditAsync(FisUser user, BuildEditorContext context)
        {
        ...
        public override async Task<IDisplayResult> UpdateAsync(FisUser user, UpdateEditorContext context)
        {
            var userClaim = _httpContextAccessor.HttpContext.User;
        ...
        private async Task<ContentItem> GetUserSettingsAsync(FisUser user, ContentTypeDefinition settingsType, Action isNew = null)
        {
            JToken property;
