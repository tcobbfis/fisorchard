...
{
    public class FisUserDisplayDriver : DisplayDriver<FisUser>
    {
        ...
        public FisUserDisplayDriver(
            UserManager<IUser> userManager,
            IHttpContextAccessor httpContextAccessor,
            INotifier notifier,
            ILogger<FisUserDisplayDriver> logger,
            IEnumerable<IUserEventHandler> userEventHandlers,
            IAuthorizationService authorizationService,
            IHtmlLocalizer<FisUserDisplayDriver> htmlLocalizer,
            IStringLocalizer<FisUserDisplayDriver> stringLocalizer)
        {
