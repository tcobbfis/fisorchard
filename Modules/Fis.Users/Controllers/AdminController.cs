...
using ResetPasswordViewModel = OrchardCore.Users.ViewModels.ResetPasswordViewModel;
using UserEntry = OrchardCore.Users.ViewModels.UserEntry;
using UserIndexOptions = OrchardCore.Users.ViewModels.UserIndexOptions;
using UsersFilter = OrchardCore.Users.ViewModels.UsersFilter;
using UsersOrder = OrchardCore.Users.ViewModels.UsersOrder;
using UsersBulkAction = OrchardCore.Users.ViewModels.UsersBulkAction;
...
namespace Fis.Users.Controllers
{
    public class AdminController : Controller
    {
        ...
        public async Task<ActionResult> Index([ModelBinder(BinderType = typeof(UserFilterEngineModelBinder), Name = "q")] QueryFilterResult<User> queryFilterResult, PagerParameters pagerParameters)
        {
            ...
            var shapeViewModel = await _shapeFactory.CreateAsync<OrchardCore.Users.ViewModels.UsersIndexViewModel>("FisUsersAdminList", viewModel =>
            {
